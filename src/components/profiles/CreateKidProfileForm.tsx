...
export interface CreateKidProfileFormProps {
    appBarTitle?: string;
    appBarLeftAction?: ReactNode;
    appBarClassName?: string;
    onCreateSuccess?: () => void;
}

export function CreateKidProfileForm({
    appBarTitle = 'Tạo tài khoản cho con',
    appBarLeftAction,
    appBarClassName = 'bg-[#f6f6f6]',
    onCreateSuccess,
}: CreateKidProfileFormProps) {
    ...
    const onSubmit = (data: CreateProfileFormInput) => {
        createProfileMutation(
            {
                profiles: data.children.map((child) => ({
