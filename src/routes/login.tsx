...
function LoginPage() {
  ...
  function validate() {
    ...
    if (form.password && form.password.length < 8) errs.password = t('auth.passwordMin')
    setErrors(errs)
    ...
    <>
      <div className="mobile-container flex flex-col">
        <div className="bg-white rounded-2xl shadow-lg w-full  h-full min-h-screen">
          <div >
            <img src="/images/logo-login.svg" alt="logo" className='w-full object-contain' />
          </div>
          <div className='flex justify-center items-center'>
            <img src="/images/tichtich-text.svg" alt="logo" className=' object-contain' />
          </div>
          <Form onSubmit={handleSubmit} className="flex flex-col gap-4 px-4 py-8">
            ...
            >
              ...
              <div className="relative flex items-center">
                ...
                >
                  {showPassword ? <Eye color='#aaa' /> : <EyeOff color='#aaa' />}
                </button>
              </div>
            </TextField>
            ...
            <Button
              type="button"
              onPress={() => alert("Chuyển tới trang tạo tài khoản")}
