...
export const Route = createLazyFileRoute('/_app/adult/notifications/')({
    component: AdultNotificationsPage,
});
...
function AdultNotificationsPage() {
